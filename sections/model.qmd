...
[^3]: \footnote{Note that the observed choice $j^*_i$ is irrelevant for this likelihood through ''Gumbel distribution magic''. Specifically, it is the ''memory-less'' property of the Gumbel that yields this property.
