...
demand estimates can ignore the distinction, because notebook 05 shows the two
...
| where | what |
|---|---|
| notebook 03 | what a coarse scale costs once the study is already fielded |
| notebook 05 | why link misspecification is second-order for demand |
| notebook 04 | the tests that use attractiveness variation to check the model |
