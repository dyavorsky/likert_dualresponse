...
Notebook 01 established that the aggregate estimator works. This one does the
...
respondents here; the heterogeneous-cut extension is exercised in notebook 05.
...
| where | what |
|---|---|
| notebook 01 | the aggregate estimator, identification, and the factorization check |
| notebook 03 | what dichotomizing the scale costs, at the individual level |
| notebook 05 | five misspecifications, including heterogeneous cut points |
