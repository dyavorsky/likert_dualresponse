...
notebook 03, but it is the benchmark the others are measured against.
...
| where | what |
|---|---|
| notebook 03 | the statistical version of this comparison |
| notebook 06 | why the cut has to be chosen before fielding |
| notebook 05 | robustness of the demand quantities used here |
